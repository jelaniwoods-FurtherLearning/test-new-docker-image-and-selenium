...
describe "/paper" do
  it "has 'Play Paper' link in white text.", {:js => true, :points => 1} do
...
describe "/paper" do
  it "has 'Play Paper' link with a blue background color. ", {:js => true, :points => 1} do
    visit "/paper"
...
describe "/paper" do
  it "has a second level heading with text 'We Played Paper!' that is green. ", {:js => true, :points => 1} do
    visit "/paper"

    within "html" do
      within "body" do
        heading = find("h2", :text => /We Played Paper/i)
...
describe "/paper" do
  it "has a 'div' that contains heading 'We Played Paper!'. ", :points => 1 do
    visit "/paper"
...
describe "/paper" do
  it "has a 'div' that contains heading 'We tied!'.", :points => 1 do
    visit "/paper"
...
describe "/paper" do
  it "has a 'div' that contains heading 'We Played Paper!' with a green border color. ", {:js => true, :points => 1} do
    visit "/paper"

    within "html" do
      within "body" do
        containing_div = find("div", :text => /We Played Paper/i)
...
describe "/paper" do
  it "has a 'div' that contains heading 'We tied!' with a red/orange border color.", {:js => true, :points => 1} do
    ...
    within "html" do
      within "body" do
        containing_div = find("div", :text => /We tied/i)
...
describe "/paper" do
  it "has a 'div' that contains heading 'We Played Paper!' that is next to a 'div' that contains 'The Played Paper!'.", {:js => true, :points => 1} do
    visit "/paper"

    within "html" do
      within "body" do
        we_played_rock_div = find("div", :text => /We Played Paper/i)
